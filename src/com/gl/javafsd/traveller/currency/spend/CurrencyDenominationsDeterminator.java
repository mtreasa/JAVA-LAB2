package com.gl.javafsd.traveller.currency.spend;
...
public class CurrencyDenominationsDeterminator {
	...
	//	Arrays.sort(denominations, Collections.reverseOrder());
		...
		//Collections.reverseOrder(denominations);
	...
	private void printErrorMessage() {
		...
		System.out.println(
			...
			//check	+ DataStructureUtils.printAndReturn(denominations) 
	...
	private void printSuccessMessage(int resultIndex) {
		...
		System.out.println("For the payment [" + payAmount +  "] and for the denominations " 
				//check + DataStructureUtils.printAndReturn(denominations) + ", the "
...
/*public class CurrencyDenominationsDeterminator {
	...
	public void determine() {
		...
		while (index< denominations.length) {
			...
			int denominationTimes = balancedOutpayAmount/ denomination; 
			int leftAmount = balancedOutpayAmount % denomination;
